...
- Securing access using authentication
- Providing analytics like monthly and category-wise summaries

This project forms a foundation for future **AI-based expense analysis**.
